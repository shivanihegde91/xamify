...
import './PerformanceDetails2.css';  // Assuming you're using the external CSS file

const PerformanceDetails2 = () => {
  return (
    <div className="performance-container">
      ...
      <div className="navigate-button-container">
        <Link to="/userperformance" className="navigate-button">
          🔗 View Performance 
        </Link>
      </div>
    </div>
...
export default PerformanceDetails2;
